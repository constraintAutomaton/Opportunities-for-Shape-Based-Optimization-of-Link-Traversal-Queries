...
Thus, the traversal proceeds domain by domain (considering that there is one domain with an abstract empty shape index containing the rest of the web) only requesting elements respecting the star pattern queries, until no new documents are reachable or a limit clause is satisfied.
