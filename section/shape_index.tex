...
They are defined by the data publisher.
A data publisher could define a Solid pod or the route pattern of a website as a domain.
It can be considered as similar to the concept of subweb of \citeauthor{Bogaerts2021LinkTW}.
}
