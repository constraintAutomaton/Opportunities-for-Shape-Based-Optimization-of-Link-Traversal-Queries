...
As defined earlier a domain is a set of URL.
They are defined by the data publisher an example of it could a Solid pod or a website route pattern of a website.
}
