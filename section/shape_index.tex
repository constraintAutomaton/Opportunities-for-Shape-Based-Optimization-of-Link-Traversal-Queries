...
whereas if a domain has comments and pasta recipes data the query engine can know it can safely limit its dereferencing operations to the set of documents related to comments without affecting results completeness given the indexes are complete in both cases.
