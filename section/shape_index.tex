...
However, the data published often adhere to an implicit schema due to the nature of their data and the formulation of RDF~\cite{Neumann2011CharacteristicSA}.
...
However instead of linking shapes to RDF subgraphs it links shapes to documents.
...
The problem consists of determining if the results of a query are a subset of the results of another query.
