\begin{abstract}
    ...
    Centralizing web data, particularly personal data, raises ethical and legal concerns.
    ...
    RDF data shapes are widely used for data validation of linked data documents, therefore, it is worthwhile to investigate their potential for LTQP optimization.
    % Task
