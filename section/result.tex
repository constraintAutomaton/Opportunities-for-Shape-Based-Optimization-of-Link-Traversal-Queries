...
In the Figure \ref{fig:result}, we notice that in the best-case scenario the percentage of the reduction can be as high as 80\% (D1V3 and S1V3) for the execution time 
...
Our approach reliably executes less HTTP requests compared to the state of the art.
...
distribution tending to be lower than the state of the art (with exeption to D3V3 and D3V4 with an augmentation of 9\% of the mean of the execution time).
...
but also in terms of the performance for single execution in unstable networks where the server might take longer times to respond. 
