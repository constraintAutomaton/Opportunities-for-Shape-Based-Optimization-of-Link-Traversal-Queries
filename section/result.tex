...
and  an integration inside the engine \href{https://github.com/comunica/comunica}{Comunica} in at this link 
...
An open implementation of the algorithm and an integration in an query engine is available online \sepfootnote{impl}.
