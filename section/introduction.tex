...
The web is a wealth of information, hence using it as a machine-usable database is a desirable solution to enable large-scale "intelligent" dynamic communication systems.
