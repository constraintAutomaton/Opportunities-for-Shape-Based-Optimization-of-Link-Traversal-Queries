...
However, most query processing over linked data is performed in centralized and federated setups, leaving approaches independent of indexing largely experimental.
