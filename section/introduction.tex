...
Link Traversal Query Processing (LTQP) \cite{hartig2016walking} propose to replace the index servers with descriptive dereferenceable IRIs 
...
Reachability criteria \cite{hartig2016walking} are a partial answer to this problem by defining completeness on the traversal of URIs
...
Previous LTQP research didn't considered the particular structure of the querying environment.
...
those assumptions to discover and prune data \cite{Taelman2023}.
