...
However, this approach relies on prior indexing, which necessitates possibly frequent expensive updates rendering the approach restrictive and hindering the natural serendipity of the web. 
...
from the structure of RDF triples to preserve the natural link between information in the web.
...
Environments like Solid describ structures using hypermedia descriptions \cite{Fielding}.
...
The type index propose a more declarative approach \cite{Taelman2017} by mapping RDF classes with sets of resources.
...
Additionally, they have been used in the context of federated query optimizations \cite{kashif2021}.
