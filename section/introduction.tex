...
Link Traversal Query Processing (LTQP) \cite{Hartig2012} propose to replace the index servers with dereferenceable IRIs 
...
the assumptions for data discovery and link pruning \cite{verborgh2020guided}.
More concretely the approach makes use of the hypermedia description of 
