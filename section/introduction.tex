...
The shape index is an early effort for data summary of descentralized dataset~\cite{Stuckenschmidt2004,Goldman1997, Harth2010} within networks of unindexed linked data documents.
